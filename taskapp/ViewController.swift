...
// 検索画面のためにUISearchBarDelegateを追加

    //以下はSearchBarに文字が入力されるごとに呼ばれるメソッド
    ...
    override func viewDidLoad() {
        ...
        SearchBar.delegate = self // 検索結果のデリゲート先を自分に設定する
        SearchBar.showsCancelButton = true // 検索窓に何も入力されていなくてもreturnキーを押せるようにする。
